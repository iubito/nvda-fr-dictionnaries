...
* Symboles mathématiques, et un traitement spécial pour le point d'exclamation après un chiffre qui représente la factorielle.
* Français :
...
* Noms de fabricants, de logiciels, de réseaux sociaux, applications en ligne : BitDefender, Facebook, GitHub, Samsung...
...
|[10 Numbers.dic](https://github.com/iubito/nvda-fr-dictionnaries/blob/main/speechdicts/10%20Numbers.dic)|Variantes Unicode de nombres (0 à 10) stylés ou encerclés, et prononciation des mots contenant un nombre  (par exemple des noms de fichiers).|
